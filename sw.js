...
const CACHE_NAME = 'exilados-v11-ball-icon-refresh';

// Arquivos que ficam no cache para funcionar offline
const STATIC_ASSETS = [
  '/',
  '/index.html',
  '/style.css?v=20260601-header-adm-fix-2',
  '/css/header.css?v=20260601-header-adm-fix-2',
  '/css/bottom-nav.css?v=20260601-header-adm-fix-2',
  '/js/core.js',
  '/js/auth.js',
  '/js/player.js',
  '/js/admin.js',
